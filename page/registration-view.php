...
<form action="index.php?page=registration" method="post" onSubmit="return validateRegistration()"> 
    <div class='formWrap'>
        <fieldset>
            ...
            <input type="email" name="email" id="email" onblur="checkEmail(this.id)" value="<?php echo Utils::escape($contact->getEmail()); ?>"/><br/>
            <div id="emailError"></div>
            <label for="username">*Username: </label><br/>
            <input type="text" name="username" id="username" onblur="checkEmpty(this.id)" value="<?php echo Utils::escape($admin->getUsername()); ?>"/><br/>
            ...
            <input type="text" name="portrait" value="<?php echo Utils::escape($contact->getPortrait()); ?>"/>
        </fieldset>
        <fieldset>
            <legend>Label Details</legend>
            <label for="labelName">*Label Name: </label><br/>
            <input type="text" name="labelName" id="labelName" onblur="checkEmpty(this.id)" value="<?php echo Utils::escape($label->getName()); ?>"/><br/>
            <div id="labelNameError"></div>
            <label for="email">Email: </label><br/>
            <input type="email" name="labelEmail" id="labelEmail" onblur="checkEmail(this.id)" value="<?php echo Utils::escape($label->getEmail()); ?>"/><br/>
            <div id="labelEmailError"></div>
            <label for="logo">Logo URL: </label><br/>
            <input type="text" name="logo" value="<?php echo Utils::escape($label->getLogo()); ?>"/><br/>
            <label for="cover">Cover Image URL: </label><br/>
            <input type="text" name="cover" value="<?php echo Utils::escape($label->getCover()); ?>"/><br/>
